...
NOTE: All methods should be defined as public NOT public static.
    ...
    public static void main(String[] args) {
       ...
       sc.setSecondNumber(4);
        System.out.println("addition is: "+sc.getAdditionResult());
        System.out.println("subtraction is: "+sc.getSubtractionResult());
        sc.setFirstNumber(5.4);
        sc.setSecondNumber(0);
        System.out.println("mutiplication is: "+sc.getMultiplicationResult());
        System.out.println("division is: "+sc.getDivisionResult());
